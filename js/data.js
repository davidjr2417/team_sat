var DATA =[
  {
    "name": "The Costs of Alzheimer’s and Other Dementia for African Americans",
    "description": "While African Americans make up only 13.6% of the U.S. population, they bear a third of the costs of Alzheimer’s disease and other dementias (AD). This is due  to substantial, but under appreciated, racial disparities in the prevalence of AD. Older African Americans are two to three times more likely to have AD compared to non-Hispanic whites. More than 20% of Americans with AD are African Americans.",

    "hyperlink": [
      {
          "title":"Check This Out",
          "label":"Costs of Alzheimers for African Americans Report",
          "alink":"http://brotherhoodofelders.net/wp-content/uploads/2019/07/Costs-of-Alzheimers-for-African-Americans-Report.pdf"
      },
      {
          "title":"Check Me Out",
          "label":"Costs of Alzheimers foasdfsdfsadr African Americans Report",
          "alink":"http://brotherhoodofelders.net/wp-content/uploads/2019/07/Costs-of-Alzheimers-for-African-Americans-Report.pdf"
      }],
    "image": ["http://brotherhoodofelders.net/wp-content/uploads/2019/07/AAN-Against-Alzheimers-400x200.png"],
    "alt": ["African American Network Against Cancer"]

  }
  // {
  //   "name": "Understanding Prostate Cancer",
  //   "description": "This animation explains the basics of prostate cancer, including risk factors, signs and symptoms, screening tests, and an overview of treatment options. You can also learn about the role and function of the prostate, and the significance of an enlarged prostate. Prostate cancer does not usually cause signs you can see or symptoms you feel, unless it is advanced. This is why screening is so important when it comes to prostate cancer. Talk with your doctor about your personal prostate cancer risk if you are a man between the ages of 40 and 50. Tell your doctor if anyone in your family has had prostate cancer and ask about other risk factors. Participating in a screening plan with your doctor can help you find prostate cancer and treat it early, and this saves lives.",
  //   "hyperlink": [{
  //         "label":"Costs of Alzheimers for African Americans Report",
  //         "link":"http://brotherhoodofelders.net/wp-content/uploads/2019/07/Costs-of-Alzheimers-for-African-Americans-Report.pdf"  }],
  //   "image": ["http://brotherhoodofelders.net/wp-content/uploads/2019/09/prostate_cancer.png"],
  //   "alt": ["Understanding Prostate Cancer"]
  //
  // }
  // ,
  // {
